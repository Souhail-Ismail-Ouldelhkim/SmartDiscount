...
// Services
 ...
 var identityApi = builder.AddProject<Projects.SmartDiscount_Identity_API>("identity-api", launchProfileName)
...
// Apps
var webhooksClient = builder.AddProject<Projects.SmartDiscount_WebhookClient>("webhooksclient", launchProfileName)
    .WithReference(webHooksApi)
    .WithEnvironment("IdentityUrl", identityEndpoint);

var webApp = builder.AddProject<Projects.SmartDiscount_WebApp>("webapp", launchProfileName)
    .WithExternalHttpEndpoints()
...
{
    const string EnvVarName = "SmartDiscount_USE_HTTP_ENDPOINTS";
